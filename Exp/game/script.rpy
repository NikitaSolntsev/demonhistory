...
label start:
    ...
    "Не знаю, сколько времени я уже сижу с растерянным и испуганным лицом."
    "Мое тело не слушается меня, я долго и неподвижно сидел в центре комнаты."
    "Воздух в комнате с каждой секундой становился все тяжелее."
    "Если бы я и мог прямо сейчас убежать - мне бы не хватило смелости."
    "Прямо сейчас..."
    "Взять и рвануть изо всех сил к выходу."
    "..."
    "Но мое тело не двигалось, как бы сильно я этого не хотел."
    "..."
